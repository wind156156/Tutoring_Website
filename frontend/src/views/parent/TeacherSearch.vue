  ...
  <div>
    ...
    <div class="section-card" style="margin-bottom: 20px;">
      <n-space :size="12" wrap>
        <n-input v-model:value="searchSubject" placeholder="按科目筛选" style="width: 160px;" clearable @keydown.enter="doSearch" />
        <n-input v-model:value="searchCity" placeholder="按城市筛选" style="width: 160px;" clearable @keydown.enter="doSearch" />
